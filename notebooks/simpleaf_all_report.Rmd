...
out_data_dir <- file.path(dirname(snakemake@output[[1]]), "simpleaf_data")
...
write_tsv(barcode_stats, file.path(out_data_dir, "barcode_stats.tsv.gz"))
```

## Proposed QC cutoffs

- UMI low threshold: `r umi_cutoff_low`
- Genes low threshold: `r genes_cutoff_low`
- UMI final threshold: `r umi_cutoff_final`
- Genes final threshold: `r genes_cutoff_final`

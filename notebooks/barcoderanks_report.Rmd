...
emptydrops_results %>%
  ...
  geom_line() +
  geom_hline(yintercept = metadata(emptydrops_results)$knee, linetype = "dashed", color = "red") +
  geom_hline(yintercept = metadata(emptydrops_results)$inflection, linetype = "dashed", color = "orange") +
